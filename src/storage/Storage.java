...
public interface Storage {
	...
	public User getUserByName(String username);											// Erledigt, aber �berpr�fen bitte
	public User getUserById(Long id);													// Erledigt, aber �berpr�fen bitte
	...
	public Picture getLatestPicture(long camId);										// Fertig, aber �berpr�fen bitte
